...
namespace Medical.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        {
            var medicalContext = _context.Appointment.Include(a => a.Doctor).Include(a => a.Patient);
        ...
        public async Task<IActionResult> Create([Bind("Id,dateAp,DoctorId,PatientId")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,dateAp,DoctorId,PatientId")] Appointment appointment)
        {
